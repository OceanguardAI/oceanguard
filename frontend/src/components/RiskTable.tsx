              ...
              <button
                ...
                className={`w-full rounded-2xl border p-3 text-left transition-colors ${
                  isSelected
                    ...
                    : "border-ocean-700/40 bg-ocean-900/50 hover:bg-ocean-800/40"
                }`}
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <div className={`truncate text-sm font-semibold ${isSelected ? "text-teal-300" : "text-slate-200"}`}>
                      {ev.id}
                    </div>
                ...
                <div className="mt-3 grid grid-cols-2 gap-3 text-[11px]">
                  <div>
                    <div className="uppercase tracking-[0.18em] text-slate-500">MPA</div>
                    <div className="mt-1 text-slate-300">
                      {ev.inside_mpa ? (
                        <span className="font-semibold text-risk-critical">Inside MPA</span>
                      ) : ev.near_mpa ? (
                        <span className="font-semibold text-risk-high">{ev.distance_to_mpa_km} km away</span>
                      ) : (
                        <span className="text-slate-500">Outside zone</span>
                      )}
                    </div>
                  </div>
                  <div>
